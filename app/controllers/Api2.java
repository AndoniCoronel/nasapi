...
public class Api2 extends Application {
    /**
     * La funcion index se encarga de extraer la imagen de la API y guardarla en la carpeta de imagenes con el idnetificador marsApi.png
    ...
    public static void index() {
        ...
        try {
            ...
            JsonArray arr = new JsonParser().parse(content.toString()).getAsJsonObject().get("photos")
                    .getAsJsonArray();
            if (arr.size()>0) {
